...
?>
        ...
        <footer id="colophon" class="site-footer row" role="contentinfo">
            ...
            <div class="author-info col-md-12 text-center">
                <h6><?php printf( esc_html__( '%1$s by: %2$s', 'desher-khobor-unv' ), 'Site developed', '<a href="//jobayerarman.github.io/" rel="developer">Jobayer Arman</a>, United Nations Online Volunteer Service' ); ?></h6>
            </div>
        </footer><!-- #colophon -->
    </div><!-- #page -->
